...
# HTTP Bearer scheme for JWT header extraction (auto_error=False to return 401 on missing auth)
...
def get_current_user(
    ...
    """
    FastAPI dependency to validate JWT token and return the currently authenticated user.
    """
